"""
Django settings for make_up_site project.
...
SECRET_KEY = '1ohy859lu966jf*_1+7qi$lb^3upn#--yrf5y5#ki^+wac6h7f'
...
ROOT_URLCONF = 'make_up_site.urls'
...
WSGI_APPLICATION = 'make_up_site.wsgi.application'
